@Library('jenkins-library@feature/fww/notification-of-new-artifacts-to-telegram')
...
def buildWithCred  = [
    ...
    [$class: 'StringBinding', credentialsId: 'fearlessTelegramBotToken', variable: 'TELEGRAM_TOKEN']
]
