import { NetworkJson, NetworkJson } from '../../../types';
...
export const EVM_NETWORKS_JSON: NetworkJson[] = [
  {
    ...
    icon: 'https://raw.githubusercontent.com/soramitsu/fearless-utils/master/icons/chains/white/ETH.svg',
    addressPrefix: 0,
    options: ['crowdloans', 'poolStaking'],
  },
  {
    ...
    assets: [
      ...
      {
        id: '887a17c7-1370-4de0-97dd-5422e294fa7fd5r334343',
        name: 'usdc',
        symbol: 'usdc',
        precision: 6,
