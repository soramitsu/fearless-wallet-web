...
const ASSET_TO_LOCATION_MAP: Record<string, Record<string, Record<string, any>>> = {
  astar: {
    '18446744073709551617': {
      // aUSD
      parents: 1,
      interior: { X2: [{ Parachain: 2000 }, { GeneralKey: '0x0001' }] },
    },
  ...
  shiden: {
    '18446744073709551616': {
      // aUSD
      parents: 1,
      interior: { X2: [{ Parachain: 2000 }, { GeneralKey: '0x0081' }] },
    },
    '340282366920938463463374607431768211455': {
      parents: 1,
      interior: 'Here',
...
export async function astarEstimateCrossChainFee(
  ...
  if (!tokenInfo.assetIndex) {
    console.info('No assetId found for Astar token');
  ...
  console.info('astar xcm tx here', extrinsic.toHex());
