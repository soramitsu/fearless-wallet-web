...
import { getReceiverLocation, POLKADOT_UNLIMITED_WEIGHT, SupportedCrossChainsMap } from './utils';
...
export async function statemintEstimateCrossChainFee(
  ...
  try {
    if (SupportedCrossChainsMap[originNetworkKey].relationMap[destinationNetworkKey].type === 'p') {
      ...
      console.info('statemint xcm tx to p here', extrinsic.toHex());
      ...
      console.info('statemint xcm tx to r here', extrinsic.toHex());
