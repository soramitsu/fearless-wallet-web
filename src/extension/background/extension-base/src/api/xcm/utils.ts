...
import { CrossChainRelation } from '../../background/types';
...
export function getMultiLocationFromParachain(
  originChain: string,
  ...
  const xcmType =
    SupportedCrossChainsMap[originChain].type + SupportedCrossChainsMap[originChain].relationMap[destinationChain].type;
