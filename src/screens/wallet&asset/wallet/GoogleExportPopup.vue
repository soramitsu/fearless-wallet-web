...
export default defineComponent({ name: 'GoogleExportPopup' ,
  data() {
    return {
      password: '',
  ...
  methods: {
    ...
    prepUploadMeta(json: KeyringPair$Json, ethWalletId?: string) {
      return {
    ...
    async createFile(json: string, options: ICreateFile['options']) {
