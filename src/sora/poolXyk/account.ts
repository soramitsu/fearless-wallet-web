...
export function assetIdToTechAssetId(api: ApiPromise, assetId: string): CodecLike {
...
export function techAccountIdToAccountId(api: ApiPromise, techAccountId: ToU8a): CodecLike {
