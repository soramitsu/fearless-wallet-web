...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    NotificationPopup: typeof import('@/components/NotificationPopup.vue')['NotificationPopup'];
    Popup: typeof import('@/components/Popup.vue')['Popup'];
    ProgressBar: typeof import('@/components/ProgressBar.vue')['ProgressBar'];
    QR: typeof import('@/components/QR.vue')['QR'];
